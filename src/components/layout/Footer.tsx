      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#faq" className="text-gray-400 hover:text-primary-400 transition-colors">FAQs</a>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="bg-dark-700 text-white px-4 py-2 rounded-l-md w-full focus:outline-none focus:ring-1 focus:ring-primary-500"
              />
              <button
                type="submit"
        ...
        <div className="border-t border-dark-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} BlockVerify. All Rights Reserved.
          </p>
